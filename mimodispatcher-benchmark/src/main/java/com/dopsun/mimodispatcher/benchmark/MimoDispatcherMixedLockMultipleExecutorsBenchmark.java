...
public class MimoDispatcherMixedLockMultipleExecutorsBenchmark {
    ...
    public static class MimoDispatcherBenchmarkState {
        ...
        public void setUp() {
            ...
            for (int i = 0; i < TOTAL_SIZE; i++) {
                ...
                if (hasExtraLock) {
                    taskLocks.put(i, ImmutableList.of(extraLock, random.nextInt(MAX_LOCK_COUNT)));
                } else {
